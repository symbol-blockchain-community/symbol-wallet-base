...
export class MultisigRoutesApi extends runtime.BaseAPI {
  ...
  async getAccountMultisigRaw(
    ...
    if (requestParameters.address === null || requestParameters.address === undefined) {
      throw new runtime.RequiredError(
        'address',
        'Required parameter requestParameters.address was null or undefined when calling getAccountMultisig.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/account/{address}/multisig`.replace(
          `{${'address'}}`,
  ...
  async getAccountMultisigGraphRaw(
    ...
    if (requestParameters.address === null || requestParameters.address === undefined) {
      throw new runtime.RequiredError(
        'address',
        'Required parameter requestParameters.address was null or undefined when calling getAccountMultisigGraph.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/account/{address}/multisig/graph`.replace(
          `{${'address'}}`,
          encodeURIComponent(String(requestParameters.address))
        ),
        method: 'GET',
  ...
  async getAccountMultisigMerkleRaw(
    ...
    if (requestParameters.address === null || requestParameters.address === undefined) {
      throw new runtime.RequiredError(
        'address',
        'Required parameter requestParameters.address was null or undefined when calling getAccountMultisigMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/account/{address}/multisig/merkle`.replace(
          `{${'address'}}`,
          encodeURIComponent(String(requestParameters.address))
        ),
        method: 'GET',
