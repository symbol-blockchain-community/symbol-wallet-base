...
export class MetadataRoutesApi extends runtime.BaseAPI {
  ...
  async getMetadataRaw(
    ...
    if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
      throw new runtime.RequiredError(
        'compositeHash',
        'Required parameter requestParameters.compositeHash was null or undefined when calling getMetadata.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/metadata/{compositeHash}`.replace(
          `{${'compositeHash'}}`,
  ...
  async getMetadataMerkleRaw(
    ...
    if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
      throw new runtime.RequiredError(
        'compositeHash',
        'Required parameter requestParameters.compositeHash was null or undefined when calling getMetadataMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/metadata/{compositeHash}/merkle`.replace(
          `{${'compositeHash'}}`,
          encodeURIComponent(String(requestParameters.compositeHash))
        ),
        method: 'GET',
