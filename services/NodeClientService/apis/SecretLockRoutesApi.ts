...
import type { MerkleStateInfoDTO, ModelError, Order, SecretLockInfoDTO, SecretLockPage } from '../models/index';
import {
...
export class SecretLockRoutesApi extends runtime.BaseAPI {
  ...
  async getSecretLockRaw(
    ...
    if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
      throw new runtime.RequiredError(
        'compositeHash',
        'Required parameter requestParameters.compositeHash was null or undefined when calling getSecretLock.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/lock/secret/{compositeHash}`.replace(
          `{${'compositeHash'}}`,
          encodeURIComponent(String(requestParameters.compositeHash))
        ),
        method: 'GET',
  ...
  async getSecretLockMerkleRaw(
    ...
    if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
      throw new runtime.RequiredError(
        'compositeHash',
        'Required parameter requestParameters.compositeHash was null or undefined when calling getSecretLockMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/lock/secret/{compositeHash}/merkle`.replace(
          `{${'compositeHash'}}`,
          encodeURIComponent(String(requestParameters.compositeHash))
        ),
        method: 'GET',
