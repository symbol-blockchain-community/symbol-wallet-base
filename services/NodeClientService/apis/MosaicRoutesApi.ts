...
import type { MerkleStateInfoDTO, ModelError, MosaicIds, MosaicInfoDTO, MosaicPage, Order } from '../models/index';
import {
...
export class MosaicRoutesApi extends runtime.BaseAPI {
  ...
  async getMosaicRaw(
    ...
    if (requestParameters.mosaicId === null || requestParameters.mosaicId === undefined) {
      throw new runtime.RequiredError(
        'mosaicId',
        'Required parameter requestParameters.mosaicId was null or undefined when calling getMosaic.'
      );
    }
  ...
  async getMosaicMerkleRaw(
    ...
    if (requestParameters.mosaicId === null || requestParameters.mosaicId === undefined) {
      throw new runtime.RequiredError(
        'mosaicId',
        'Required parameter requestParameters.mosaicId was null or undefined when calling getMosaicMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/mosaics/{mosaicId}/merkle`.replace(
          `{${'mosaicId'}}`,
          encodeURIComponent(String(requestParameters.mosaicId))
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
  ...
  async getMosaicsRaw(
    ...
    if (requestParameters.mosaicIds === null || requestParameters.mosaicIds === undefined) {
      throw new runtime.RequiredError(
        'mosaicIds',
        'Required parameter requestParameters.mosaicIds was null or undefined when calling getMosaics.'
      );
    }
