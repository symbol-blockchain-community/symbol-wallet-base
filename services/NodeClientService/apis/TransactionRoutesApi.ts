...
export class TransactionRoutesApi extends runtime.BaseAPI {
  ...
  async announceCosignatureTransactionRaw(
    ...
    if (requestParameters.cosignature === null || requestParameters.cosignature === undefined) {
      throw new runtime.RequiredError(
        'cosignature',
        'Required parameter requestParameters.cosignature was null or undefined when calling announceCosignatureTransaction.'
      );
    }
  ...
  async announcePartialTransactionRaw(
    ...
    if (requestParameters.transactionPayload === null || requestParameters.transactionPayload === undefined) {
      throw new runtime.RequiredError(
        'transactionPayload',
        'Required parameter requestParameters.transactionPayload was null or undefined when calling announcePartialTransaction.'
      );
    }
  ...
  async announceTransactionRaw(
    ...
    if (requestParameters.transactionPayload === null || requestParameters.transactionPayload === undefined) {
      throw new runtime.RequiredError(
        'transactionPayload',
        'Required parameter requestParameters.transactionPayload was null or undefined when calling announceTransaction.'
      );
    }
  ...
  async getConfirmedTransactionRaw(
    ...
    if (requestParameters.transactionId === null || requestParameters.transactionId === undefined) {
      throw new runtime.RequiredError(
        'transactionId',
        'Required parameter requestParameters.transactionId was null or undefined when calling getConfirmedTransaction.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/transactions/confirmed/{transactionId}`.replace(
          `{${'transactionId'}}`,
  ...
  async getConfirmedTransactionsRaw(
    ...
    if (requestParameters.transactionIds === null || requestParameters.transactionIds === undefined) {
      throw new runtime.RequiredError(
        'transactionIds',
        'Required parameter requestParameters.transactionIds was null or undefined when calling getConfirmedTransactions.'
      );
    }
  ...
  async getPartialTransactionRaw(
    ...
    if (requestParameters.transactionId === null || requestParameters.transactionId === undefined) {
      throw new runtime.RequiredError(
        'transactionId',
        'Required parameter requestParameters.transactionId was null or undefined when calling getPartialTransaction.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/transactions/partial/{transactionId}`.replace(
          `{${'transactionId'}}`,
          encodeURIComponent(String(requestParameters.transactionId))
        ),
        method: 'GET',
  ...
  async getPartialTransactionsRaw(
    ...
    if (requestParameters.transactionIds === null || requestParameters.transactionIds === undefined) {
      throw new runtime.RequiredError(
        'transactionIds',
        'Required parameter requestParameters.transactionIds was null or undefined when calling getPartialTransactions.'
      );
    }
  ...
  async getUnconfirmedTransactionRaw(
    ...
    if (requestParameters.transactionId === null || requestParameters.transactionId === undefined) {
      throw new runtime.RequiredError(
        'transactionId',
        'Required parameter requestParameters.transactionId was null or undefined when calling getUnconfirmedTransaction.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/transactions/unconfirmed/{transactionId}`.replace(
          `{${'transactionId'}}`,
          encodeURIComponent(String(requestParameters.transactionId))
        ),
        method: 'GET',
  ...
  async getUnconfirmedTransactionsRaw(
    ...
    if (requestParameters.transactionIds === null || requestParameters.transactionIds === undefined) {
      throw new runtime.RequiredError(
        'transactionIds',
        'Required parameter requestParameters.transactionIds was null or undefined when calling getUnconfirmedTransactions.'
      );
    }
