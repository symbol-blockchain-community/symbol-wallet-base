...
export class AccountRoutesApi extends runtime.BaseAPI {
  ...
  async getAccountInfoRaw(
    ...
    if (requestParameters.accountId === null || requestParameters.accountId === undefined) {
      throw new runtime.RequiredError(
        'accountId',
        'Required parameter requestParameters.accountId was null or undefined when calling getAccountInfo.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/accounts/{accountId}`.replace(
          `{${'accountId'}}`,
  ...
  async getAccountInfoMerkleRaw(
    ...
    if (requestParameters.accountId === null || requestParameters.accountId === undefined) {
      throw new runtime.RequiredError(
        'accountId',
        'Required parameter requestParameters.accountId was null or undefined when calling getAccountInfoMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/accounts/{accountId}/merkle`.replace(
          `{${'accountId'}}`,
          encodeURIComponent(String(requestParameters.accountId))
        ),
        method: 'GET',
