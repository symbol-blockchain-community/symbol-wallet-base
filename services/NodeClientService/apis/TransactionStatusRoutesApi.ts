...
import type { ModelError, TransactionHashes, TransactionStatusDTO } from '../models/index';
import {
  ModelErrorFromJSON,
  ModelErrorToJSON,
...
export class TransactionStatusRoutesApi extends runtime.BaseAPI {
  ...
  async getTransactionStatusRaw(
    ...
    if (requestParameters.hash === null || requestParameters.hash === undefined) {
      throw new runtime.RequiredError(
        'hash',
        'Required parameter requestParameters.hash was null or undefined when calling getTransactionStatus.'
      );
    }
  ...
  async getTransactionStatusesRaw(
    ...
    if (requestParameters.transactionHashes === null || requestParameters.transactionHashes === undefined) {
      throw new runtime.RequiredError(
        'transactionHashes',
        'Required parameter requestParameters.transactionHashes was null or undefined when calling getTransactionStatuses.'
      );
    }
