...
export class RestrictionMosaicRoutesApi extends runtime.BaseAPI {
  ...
  async getMosaicRestrictionsRaw(
    ...
    if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
      throw new runtime.RequiredError(
        'compositeHash',
        'Required parameter requestParameters.compositeHash was null or undefined when calling getMosaicRestrictions.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/restrictions/mosaic/{compositeHash}`.replace(
          `{${'compositeHash'}}`,
  ...
  async getMosaicRestrictionsMerkleRaw(
    ...
    if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
      throw new runtime.RequiredError(
        'compositeHash',
        'Required parameter requestParameters.compositeHash was null or undefined when calling getMosaicRestrictionsMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/restrictions/mosaic/{compositeHash}/merkle`.replace(
          `{${'compositeHash'}}`,
          encodeURIComponent(String(requestParameters.compositeHash))
        ),
        method: 'GET',
