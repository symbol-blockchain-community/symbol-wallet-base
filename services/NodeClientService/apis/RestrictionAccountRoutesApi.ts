...
export class RestrictionAccountRoutesApi extends runtime.BaseAPI {
  ...
  async getAccountRestrictionsRaw(
    ...
    if (requestParameters.address === null || requestParameters.address === undefined) {
      throw new runtime.RequiredError(
        'address',
        'Required parameter requestParameters.address was null or undefined when calling getAccountRestrictions.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/restrictions/account/{address}`.replace(
          `{${'address'}}`,
  ...
  async getAccountRestrictionsMerkleRaw(
    ...
    if (requestParameters.address === null || requestParameters.address === undefined) {
      throw new runtime.RequiredError(
        'address',
        'Required parameter requestParameters.address was null or undefined when calling getAccountRestrictionsMerkle.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/restrictions/account/{address}/merkle`.replace(
          `{${'address'}}`,
          encodeURIComponent(String(requestParameters.address))
        ),
        method: 'GET',
