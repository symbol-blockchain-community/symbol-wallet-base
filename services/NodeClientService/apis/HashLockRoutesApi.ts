...
import type { HashLockInfoDTO, HashLockPage, MerkleStateInfoDTO, ModelError, Order } from '../models/index';
import {
...
export class HashLockRoutesApi extends runtime.BaseAPI {
  ...
  async getHashLockRaw(
    ...
    if (requestParameters.hash === null || requestParameters.hash === undefined) {
      throw new runtime.RequiredError(
        'hash',
        'Required parameter requestParameters.hash was null or undefined when calling getHashLock.'
      );
    }
  ...
  async getHashLockMerkleRaw(
    ...
    if (requestParameters.hash === null || requestParameters.hash === undefined) {
      throw new runtime.RequiredError(
        'hash',
        'Required parameter requestParameters.hash was null or undefined when calling getHashLockMerkle.'
      );
    }
