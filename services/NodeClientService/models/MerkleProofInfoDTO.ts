...
export function MerkleProofInfoDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): MerkleProofInfoDTO {
  ...
  return {
    merklePath: !exists(json, 'merklePath')
      ? undefined
      : (json['merklePath'] as Array<any>).map(MerklePathItemDTOFromJSON),
  };
}
...
export function MerkleProofInfoDTOToJSON(value?: MerkleProofInfoDTO | null): any {
  ...
  return {
    merklePath:
      value.merklePath === undefined ? undefined : (value.merklePath as Array<any>).map(MerklePathItemDTOToJSON),
  };
}
